...
class neutrino_transport_shared_mem_endpoint_proxy_Fixture : public ::testing::Test {
  ...
  void SetUp() override {
    ...
    {
      const auto sz = num_buffers * buf_size * 10000 /*big value here guarantees no errors even with MT env*/;
...
{
  // this test ensures a combo o singlethread_shared_memory_endpoint_proxy_t -> win_shared_mem::v00_async_listener_t
...
TEST_F(neutrino_transport_shared_mem_endpoint_proxy_Fixture, exclusive_mt_shared_memory_endpoint_proxy_t)
{
  // this test ensures a combo o singlethread_shared_memory_endpoint_proxy_t -> win_shared_mem::v00_async_listener_t
  // transfers data with no corruptions, no missed bbytes, no overlaps
...
TEST_F(neutrino_transport_shared_mem_endpoint_proxy_Fixture, optimistic_mt_shared_memory_endpoint_proxy_t)
{
  // this test ensures a combo o singlethread_shared_memory_endpoint_proxy_t -> win_shared_mem::v00_async_listener_t
  // transfers data with no corruptions, no missed bbytes, no overlaps
